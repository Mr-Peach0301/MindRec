...
class SingleRunner:
    def parse_runner_args(parser):
        ...
        parser.add_argument("--backbone", type=str, default='/model/t5_model', help='backbone model name')
        parser.add_argument("--metrics", type=str, default='hit@1,hit@3,hit@5,ndcg@3,ndcg@5', help='Metrics used for evaluation')
