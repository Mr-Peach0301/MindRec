...
def train(args):
    ...
    add_num = tokenizer.add_tokens(train_dataset.datasets[-1].get_new_tokens())
    ...
    valid_dataset = MyDataset(valid_dataset, tokenizer)
    ...
    for epoch in range(args.epochs):
        ...
        for batch in tqdm(train_loader):
            ...
            prompt_mask = (token_positions < prompt_lengths.unsqueeze(1)) | (input_ids < mask_threshold)
