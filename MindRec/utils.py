...
from data import SeqRecDataset, SeqRecTestDataset
...
def parse_train_args(parser):
    ...
    parser.add_argument("--lora_modules_to_save", type=str,
                        default="wte,transformer.ff_out", help="separate by comma")
...
def parse_test_args(parser):
    ...
    parser.add_argument("--metrics", type=str, default="ndcg@1,ndcg@3,ndcg@5,ndcg@10,hit@3,hit@5,hit@10",
...
def load_datasets(args):
    ...
    valid_data = SeqRecDataset(args, mode="valid", sample_num=args.valid_prompt_sample_num)
