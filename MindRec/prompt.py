...
#####——17
prompt = {}
prompt["instruction"] = "The user has interacted with items {inters} in chronological order. Can you predict the next possible item that the user may expect? Please provide a ranked list of the top 10 most probable candidate items. The list should be ordered from the highest probability to the lowest."
prompt["response"] = "1. {c1}{c2}{c3}-{item}, 2. {c1}{c2}{c3}-{item}, 3. {c1}{c2}{c3}-{item}, 4. {c1}{c2}{c3}-{item}, 5. {c1}{c2}{c3}-{item}, 6. {c1}{c2}{c3}-{item}, 7. {c1}{c2}{c3}-{item}, 8. {c1}{c2}{c3}-{item}, 9. {c1}{c2}{c3}-{item}, 10. {c1}{c2}{c3}-{item}"
mindrec_prompt.append(prompt)
